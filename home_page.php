...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-white w3-card" id="myNavbar">
            ...
            <div class="w3-left w3-hide-small" style="margin-left:200px;">
                <a href="#why stockinvo?" class="w3-bar-item w3-button" style="margin-right: 30px;"><i class="fas fa-question-circle"></i> Why apni dukaan</a>
    ...
    <div class="w3-container" style="padding:128px 16px" id="why stockinvo?">
        <h2 class="w3-center"><b>Why Apni Dukaan?</b></h2>
        <div class="w3-row-padding w3-center" style="margin-top:64px">
            ...
            <div class="w3-quarter">
                ...
                <p>Apni Dukaan offers real-time financial and sales reports, enabling you to make better decisions day-to-day, instead of only getting to your insights at the end of the month.</p>
            </div>
            <div class="w3-quarter">
                <i class="fa fa-chalkboard-teacher w3-margin-bottom w3-jumbo"></i>
                <p class="w3-large">Implements 100%</p>
                <p>The best thing about Apni Dukaan is that it’s extremely easy to understand and use.</p>
            </div>
            <div class="w3-quarter">
                <i class="fa fa-chart-line w3-margin-bottom w3-jumbo"></i>
                <p class="w3-large">Gain insight into inventory</p>
                <p>Apni Dukaan allows you to track inventory costs in real time and manage your inventory efficiently in the warehouse.</p>
            </div>
        </div>
    </div>
    ...
    <div class="w3-container w3-light-grey" style="padding:90px 30px" id="how it works?">
        ...
        <div class="w3-row-padding">
            <div class="w3-col m6">
                ...
                <p>Apni Dukaan makes monitoring and managing your billing and upcoming expenses very simple. Right from the home page having features like total sales for the current day, reorder point and list of expired products - Apni Dukaan offers you everything in a few clicks.</p>
            </div>
    ...
    <div class="w3-container w3-padding-64 w3-theme-l5" id="contact us">
        ...
        <div class="w3-row">
            <div class="w3-col m5">
                ...
                <p><i class="fa fa-envelope-o w3-xlarge" style="color: #074b82;"></i>apnidukaan@gmail.com</p>
                <br>
